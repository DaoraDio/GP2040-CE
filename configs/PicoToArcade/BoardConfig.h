...
#define GPIO_PIN_15 GpioAction::BUTTON_PRESS_L3     
...
#define GPIO_PIN_22 GpioAction::BUTTON_PRESS_R3
#define GPIO_PIN_26 GpioAction::SUSTAIN_DP_MODE_RS
#define GPIO_PIN_27 GpioAction::SUSTAIN_DP_MODE_LS
